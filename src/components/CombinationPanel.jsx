  ...
  return (
    <section className="rounded-lg border border-zinc-200 bg-white p-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-base font-semibold">100만원 조합 찾기</h2>
          <p className="mt-1 text-sm text-zinc-500">
            선택된 {selectedReceipts.length}건 합계{" "}
        ...
        <div className="mt-4 rounded-lg border border-zinc-200 bg-zinc-50 p-4">
          <p className="text-sm font-semibold text-zinc-900">
            {combinationResult.type === "exact"
              ? "정확히 1,000,000원 조합을 찾았습니다."
              : "정확한 조합이 없어 1,000,000원 미만 최대 조합을 찾았습니다."}
          </p>
          <p className="mt-1 text-sm text-zinc-600">
            결과 합계: {combinationResult.total.toLocaleString()}원
          </p>
